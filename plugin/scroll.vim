" Modified version of ScrollColors.vim for ThemerCorp/themer.lua
" Modified by: Astro [@narutoxy]
" 
...
function! s:RefreshColorschemesList() 
    let x=globpath(&rtp, "colors/themer_*.lua")
    let y=substitute(x."\n","\\(^\\|\n\\)[^\n]*[/\\\\]", "\n", "g")
    let z=substitute(y,"\\.lua\n", "\n", "g")
    let sorted = s:SortVar(substitute(z, "\nthemer_", "\n", "g"), "\n")
